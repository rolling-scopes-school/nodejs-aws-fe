...
class ServerlessPlugin {
  ...
  runAwsCommand(args) {
    ...
    if (this.serverless.variables.service.provider.region) {
      commandArgs = ['--region', this.serverless.variables.service.provider.region];
    }
    if (this.serverless.variables.service.provider.profile) {
      commandArgs = ['--profile', this.serverless.variables.service.provider.profile];
    }
    const result = spawnSync('aws', commandArgs.concat(args));
